...
You'll use two sets of tools in this class: an x86 emulator, [QEMU](https://pdos.csail.mit.edu/6.828/2018/tools.html#qemu), for running your kernel; and a [compiler toolchain](https://pdos.csail.mit.edu/6.828/2018/tools.html#chain), including assembler, linker, C compiler, and debugger, for compiling and testing your kernel. This page has the information you'll need to download and install your own copies. This class assumes familiarity with Unix commands throughout.
...
For an overview of useful commands in the tools used in 6.828, see the [lab tools guide](https://pdos.csail.mit.edu/6.828/2018/labguide.html).
...
-   [VirtualBox](http://www.oracle.com/us/technologies/virtualization/oraclevm/) (free for Mac, Linux, Windows) --- [Download page](http://www.oracle.com/us/technologies/virtualization/oraclevm/)
-   [VMware Player](http://www.vmware.com/products/player/) (free for Linux and Windows, registration required)
-   [VMware Fusion](http://www.vmware.com/products/fusion/) (Downloadable from IS&T for free).
...
-   [Ubuntu Desktop](http://www.ubuntu.com/download/desktop) is what we use.
...
[QEMU](http://www.nongnu.org/qemu/) is a modern and fast PC emulator. QEMU version 2.3.0 is set up on Athena for x86 machines in the 6.828 locker (`add -f 6.828`)
